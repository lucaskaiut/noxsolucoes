...
export function Differentials() {
  return (
    <section
      ...
      className="relative scroll-mt-24 bg-ice-100 py-20 sm:py-28"
    >
      <Container>
        <SectionHeading
        ...
        <div className="mt-14 grid gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
          {differentials.map((item) => (
            <div key={item.title} className="flex gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-white text-brand-600 shadow-sm shadow-slate-900/5">
